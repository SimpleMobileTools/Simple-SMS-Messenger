...
@Database(entities = [Conversation::class, ArchivedMessage::class, Attachment::class, MessageAttachment::class, Message::class], version = 8)
...
abstract class MessagesDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_7_8 = object : Migration(7, 8) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.apply {
                    execSQL("CREATE TABLE IF NOT EXISTS archived_messages (`id` INTEGER NOT NULL PRIMARY KEY, `deleted_ts` INTEGER NOT NULL)")
                    execSQL("CREATE UNIQUE INDEX IF NOT EXISTS `index_archive_messages_id` ON `archived_messages` (`id`)")
                }
            }
        }
    }
